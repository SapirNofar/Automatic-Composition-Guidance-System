...
//UI Constants
static const CGFloat kPopupViewHeight = 207.0;  /// fix size
@interface SHDPhotoPreviewViewController ()<SHDSharePopupViewDelegate>
...
- (BOOL)shouldAutorotate{ // check if that rotate camera
    return NO;
}
