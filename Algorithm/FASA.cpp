...
Mat squares             = (Mat)Mat::zeros(1, 10000, CV_32FC1);
...
int precomputeParameters(Mat histogram,
    ...
    Mat problematic         = (Mat)Mat::zeros(histogram.cols, 1, CV_32SC1);
    
    Mat closestElement      = (Mat)Mat::zeros(histogram.cols, 1, CV_32SC1);
...
void bilateralFiltering(Mat colorDistance,
    ...
    Mat X       = (Mat)Mat::zeros(1, numberOfColors, CV_32FC1);
    Mat Y       = (Mat)Mat::zeros(1, numberOfColors, CV_32FC1);
    Mat X2      = (Mat)Mat::zeros(1, numberOfColors, CV_32FC1);
    Mat Y2      = (Mat)Mat::zeros(1, numberOfColors, CV_32FC1);
    Mat NF      = (Mat)Mat::zeros(1, numberOfColors, CV_32FC1);
...
//////////////////////// SALIENCY COMPUTATION STARTS HERE ////////////////////////
            ...
            Mat SM = (Mat)Mat::zeros(im.rows, im.cols, CV_8UC1);
...
//////////////////////// SALIENCY COMPUTATION ENDS HERE ////////////////////////
            ...
            Mat saliencyProbabilityImage    = (Mat)Mat::zeros(im.rows, im.cols, CV_32FC1);
            Mat globalContrastImage         = (Mat)Mat::zeros(im.rows, im.cols, CV_32FC1);
