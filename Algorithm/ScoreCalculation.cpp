...
cv::Mat calc9(cv::Mat im, cv::Point startPoint, int range_height, int range_width)
{
    ...
    if(startPoint.x - JUMP >= 0 && startPoint.y + JUMP < im.rows)
    {
